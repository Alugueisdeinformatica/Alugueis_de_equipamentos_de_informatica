 ...
 * @author JohnPeter
 */
public class FormAluguelTeste extends javax.swing.JFrame {
    ...
    public static void setCliente(Cliente cliente) {
        FormAluguelTeste.cliente = cliente;
    }    
    
    /**
     * Creates new form FormAluguelTeste
     */
    public FormAluguelTeste() {        
        initComponents();
        aluguel = new Aluguel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAluguelTeste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
